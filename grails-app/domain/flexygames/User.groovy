...
//		return null
	...
	// damned pourquoi le SortedSet "participations" ne se remplit qu'avec une seul élement ? Evidemment passer en lazy:false change rien alors on le fait à la main :(

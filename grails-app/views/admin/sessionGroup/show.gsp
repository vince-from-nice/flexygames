...
<html>
    ...
    <body>
        ...
        <div id="show-sessionGroup" class="content scaffold-show" role="main">
            ...
            <f:display bean="sessionGroup" />
            <g:form resource="${this.sessionGroup}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sessionGroup}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

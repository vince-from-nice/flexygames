...
<html>
    ...
    <body>
        ...
        <div id="show-reminder" class="content scaffold-show" role="main">
            ...
            <f:display bean="reminder" />
            <g:form resource="${this.reminder}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.reminder}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

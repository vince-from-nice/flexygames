...
<html>
    ...
    <body>
        ...
        <div id="show-playground" class="content scaffold-show" role="main">
            ...
            <f:display bean="playground" />
            <g:form resource="${this.playground}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.playground}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

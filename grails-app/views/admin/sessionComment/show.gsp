...
<html>
    ...
    <body>
        ...
        <div id="show-sessionComment" class="content scaffold-show" role="main">
            ...
            <f:display bean="sessionComment" />
            <g:form resource="${this.sessionComment}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sessionComment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-blogComment" class="content scaffold-show" role="main">
            ...
            <f:display bean="blogComment" />
            <g:form resource="${this.blogComment}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.blogComment}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

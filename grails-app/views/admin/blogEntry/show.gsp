...
<html>
    ...
    <body>
        ...
        <div id="show-blogEntry" class="content scaffold-show" role="main">
            ...
            <f:display bean="blogEntry" />
            <g:form resource="${this.blogEntry}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.blogEntry}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-gameType" class="content scaffold-show" role="main">
            ...
            <f:display bean="gameType" />
            <g:form resource="${this.gameType}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.gameType}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

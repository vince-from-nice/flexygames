...
<html>
    ...
    <body>
        ...
        <div id="show-gameSkill" class="content scaffold-show" role="main">
            ...
            <f:display bean="gameSkill" />
            <g:form resource="${this.gameSkill}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.gameSkill}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

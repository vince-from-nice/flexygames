...
<html>
    ...
    <body>
        ...
        <div id="show-carpoolProposal" class="content scaffold-show" role="main">
            ...
            <f:display bean="carpoolProposal" />
            <g:form resource="${this.carpoolProposal}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.carpoolProposal}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-participation" class="content scaffold-show" role="main">
            ...
            <f:display bean="participation" />
            <g:form resource="${this.participation}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.participation}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-carpoolRequest" class="content scaffold-show" role="main">
            ...
            <f:display bean="carpoolRequest" />
            <g:form resource="${this.carpoolRequest}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.carpoolRequest}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-sessionRound" class="content scaffold-show" role="main">
            ...
            <f:display bean="sessionRound" />
            <g:form resource="${this.sessionRound}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.sessionRound}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

...
<html>
    ...
    <body>
        ...
        <div id="show-gameAction" class="content scaffold-show" role="main">
            ...
            <f:display bean="gameAction" />
            <g:form resource="${this.gameAction}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.gameAction}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

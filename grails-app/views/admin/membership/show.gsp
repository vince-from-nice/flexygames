...
<html>
    ...
    <body>
        ...
        <div id="show-membership" class="content scaffold-show" role="main">
            ...
            <f:display bean="membership" />
            <g:form resource="${this.membership}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.membership}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

	...
	<body>
		...
		<div id="show-sessionGroup" class="content scaffold-show" role="main">
			...
			<ol class="property-list sessionGroup">
				...
				<g:if test="${sessionGroupInstance?.defaultDuration}">
				<li class="fieldcontain">
					<span id="defaultDuration-label" class="property-label"><g:message code="sessionGroup.defaultDuration.label" default="Default Duration" /></span>
					
						<span class="property-value" aria-labelledby="defaultDuration-label"><g:fieldValue bean="${sessionGroupInstance}" field="defaultDuration"/></span>
				...
				<li class="fieldcontain">
					<span id="defaultLockingTime-label" class="property-label"><g:message code="sessionGroup.defaultLockingTime.label" default="Default Locking Time" /></span>
					
						<span class="property-value" aria-labelledby="defaultLockingTime-label"><g:fieldValue bean="${sessionGroupInstance}" field="defaultLockingTime"/></span>
			...
			<g:form url="[resource:sessionGroupInstance, action:'delete']" method="DELETE">
				<fieldset class="buttons">
					<g:link class="edit" action="edit" resource="${sessionGroupInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

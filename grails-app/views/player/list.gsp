			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn style="font-size: 10px; vertical-align: middle" property="votingScoreCounter" title="${message(code: 'votes', default: 'Votes')}" />
				...
				<tbody>
					<g:each in="${playerInstanceList}" status="i" var="playerInstance">
						...
						<tr class="${(i % 2) == 0 ? 'odd' : 'even'}" style="height: 50px; cursor: pointer" onclick="document.location='${playerLink}'">
							...
							<td style="vertical-align: middle;">
								${playerInstance.votingScoreCounter}
							</td>
							<td style="vertical-align: middle;">

...
<table class="sessionZoneTab">
	<tr style="vertical-align: middle; cursor: pointer" onclick="toggleDisplay('scorescheetSummaryZone'); toggleDisplay('scorescheetDetailedZone'); return false">
		<th>

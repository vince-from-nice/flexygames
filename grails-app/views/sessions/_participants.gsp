...
<table class="sessionZoneTab">
	<tr style="vertical-align: middle; cursor: pointer" onclick="toggleTableDisplay('participantsSummaryZone'); toggleTableDisplay('participantsDetailedZone'); return false">
		<th>
	...
	<tr>
		<td colspan="2">
			<table class="flexyTab" id="participantsSummaryZone" style="display: table; width: 100%; ">
